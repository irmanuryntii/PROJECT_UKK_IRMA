    ...
    <style>
        * {
        ...
        body {
            ...
            padding: 20px;
            background: url('bgir.jpg') no-repeat;
        ...
        .task-item {
            background: #D8B9FF; /* Warna lebih terang */
        ...
        .task-list {
            ...
            background-color: #D2AFFF; /* Warna latar belakang untuk membedakan */
...
<body>
<h1 class="main-title">MY TO-DO LIST CHECK</h1>
<!-- Form Pencarian -->
<div class="container pencarian-tugas">
    <h2>SEARCH TASK</h2>
    <form action="" method="get" class="search-form">
        <input type="text" name="search" placeholder="Find Task..." value="<?= htmlspecialchars($search_query) ?>">
...
<div class="container tambah-tugas">
    ...
    <form action="" method="POST">
        ...
        <div id="sub-task-container">
            ...
            ?>
            <button type="button" class="btn-subtask" onclick="tambahSubtask()">Add Subtask</button>
        </div>
        ...
        <button type="submit" class="btn"><?= $edit_task ? 'Update Task' : 'Add Task' ?></button>
    </form>
</div>
<?php } ?>
            ...
            <div class="task-item <?= $r['taskstatus'] == 'close' ? 'completed' : '' ?> <?= $isOverdue ? 'completed' : '' ?>">
                <div class="task-header">
                    ...
                    <div class="actions">
                        ...
                        <a href="?delete=<?= $r['id'] ?>" class="text-red" title="Remove" onclick="return confirm('Are you sure you want to delete?')">
